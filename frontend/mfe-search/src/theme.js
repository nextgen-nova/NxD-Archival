...
function envTokens() {
  const headingColor = process.env.REACT_APP_HEADING_COLOR || "#0f172a";
  const textColor = process.env.REACT_APP_TEXT_COLOR || "#475569";
  return {
    ...
    "--black":            headingColor,
    "--black-3":          textColor,
    "--gray-2":           tintHex(textColor, 0.18),
    "--gray-3":           tintHex(textColor, 0.48),
    ...
    "--search-font-size-xs": process.env.REACT_APP_SEARCH_FONT_SIZE_XS || "11px",
    "--search-font-size-sm": process.env.REACT_APP_SEARCH_FONT_SIZE_SM || "12px",
    "--search-font-size-base": process.env.REACT_APP_SEARCH_FONT_SIZE_BASE || "13px",
    "--search-font-size-lg": process.env.REACT_APP_SEARCH_FONT_SIZE_LG || "14px",
  };
}
